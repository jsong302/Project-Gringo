...
export function seedCurriculumIfEmpty(): void {
  ...
  curLog.info('Seeding default curriculum (40 units)...');
  const db = getDb();
...
const DEFAULT_CURRICULUM: DefaultUnit[] = [
  // ── Level 1: Survival Basics (Units 1-10) ──
  {
  ...
  {
    order: 3, topic: 'ser_estar', title: 'Ser vs Estar', levelBand: 1,
  ...
  {
    order: 4, topic: 'present_tense', title: 'Present Tense (Regular Verbs)', levelBand: 1,
  ...
  {
    order: 5, topic: 'food_ordering', title: 'Food & Ordering', levelBand: 1,
  ...
  {
    order: 6, topic: 'getting_around', title: 'Getting Around', levelBand: 1,
  ...
  {
    order: 7, topic: 'family', title: 'Family & Relationships', levelBand: 1,
  ...
  {
    order: 8, topic: 'time_schedule', title: 'Time & Schedule', levelBand: 1,
  ...
  {
    order: 9, topic: 'shopping_money', title: 'Shopping & Money', levelBand: 1,
  ...
  {
    order: 10, topic: 'review_1', title: 'Level 1 Review & Consolidation', levelBand: 1,
  ...
  // ── Level 2: Conversational Foundations (Units 11-20) ──
  {
    order: 11, topic: 'voseo', title: 'Voseo Introduction', levelBand: 2,
  ...
  {
    order: 12, topic: 'past_preterite', title: 'Past Tense (Pretérito)', levelBand: 2,
  ...
  {
    order: 13, topic: 'describing', title: 'Describing People & Places', levelBand: 2,
  ...
  {
    order: 14, topic: 'weather_smalltalk', title: 'Weather & Small Talk', levelBand: 2,
  ...
  {
    order: 15, topic: 'faith_basics', title: 'At the Church', levelBand: 2,
  ...
  {
    order: 16, topic: 'feelings', title: 'Feelings & Emotions', levelBand: 2,
  ...
  {
    order: 17, topic: 'phone_messaging', title: 'Phone & Messaging', levelBand: 2,
  ...
  {
    order: 18, topic: 'health_emergencies', title: 'Health & Emergencies', levelBand: 2,
  ...
  {
    order: 19, topic: 'imperfect', title: 'Imperfect Tense', levelBand: 2,
  ...
  {
    order: 20, topic: 'review_2', title: 'Level 2 Review & Real Conversations', levelBand: 2,
  ...
  // ── Level 3: Intermediate Expression (Units 21-30) ──
  {
    order: 21, topic: 'lunfardo_basics', title: 'Lunfardo Basics', levelBand: 3,
  ...
  {
    order: 22, topic: 'subjunctive_intro', title: 'Subjunctive Introduction', levelBand: 3,
  ...
  {
    order: 23, topic: 'sharing_faith', title: 'Sharing Your Faith', levelBand: 3,
  ...
  {
    order: 24, topic: 'opinions', title: 'Opinions & Debate', levelBand: 3,
  ...
  {
    order: 25, topic: 'argentine_culture', title: 'Argentine Culture', levelBand: 3,
  ...
  {
    order: 26, topic: 'narrating', title: 'Narrating Events', levelBand: 3,
  ...
  {
    order: 27, topic: 'conditional', title: 'Conditional Tense', levelBand: 3,
  ...
  {
    order: 28, topic: 'youth_slang', title: 'Slang & Youth Language', levelBand: 3,
  ...
  {
    order: 29, topic: 'prayer_worship', title: 'Prayer & Worship', levelBand: 3,
  ...
  {
    order: 30, topic: 'review_3', title: 'Level 3 Review & Storytelling', levelBand: 3,
  ...
  // ── Level 4: Advanced Fluency (Units 31-40) ──
  {
    order: 31, topic: 'vesre', title: 'Vesre (Word Reversal)', levelBand: 4,
  ...
  {
    order: 32, topic: 'past_subjunctive', title: 'Complex Subjunctive', levelBand: 4,
  ...
  {
    order: 33, topic: 'humor_irony', title: 'Argentine Humor & Irony', levelBand: 4,
  ...
  {
    order: 34, topic: 'pastoral_care', title: 'Pastoral Conversations', levelBand: 4,
  ...
  {
    order: 35, topic: 'idioms', title: 'Idioms & Refranes', levelBand: 4,
  ...
  {
    order: 36, topic: 'social_topics', title: 'Social & Current Topics', levelBand: 4,
  ...
  {
    order: 37, topic: 'advanced_lunfardo', title: 'Advanced Lunfardo', levelBand: 4,
  ...
  {
    order: 38, topic: 'bible_study', title: 'Leading a Bible Study', levelBand: 4,
  ...
  {
    order: 39, topic: 'native_speed', title: 'Native-Speed Comprehension', levelBand: 4,
  ...
  {
    order: 40, topic: 'review_final', title: 'Final Review & Graduation', levelBand: 4,
