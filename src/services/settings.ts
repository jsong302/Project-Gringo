...
export const DEFAULT_SETTINGS: Array<{ key: string; value: unknown; description: string }> = [
  ...
  { key: 'cron.queue_refill', value: '0 11 * * *', description: 'Cron schedule for auto-refilling content queues when low (default: 7am ET / 11:00 UTC daily)' },
  ...
  { key: 'exit_exam.question_count', value: 15, description: 'Number of questions per exit exam attempt' },
